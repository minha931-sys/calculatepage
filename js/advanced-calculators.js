(function(){
  ...
  if(guides[type])root.insertAdjacentHTML('beforeend',`<section class="content-block"><h2>${guides[type][0]}</h2><p>${guides[type][1]}</p></section><section class="content-block"><h2>관련 계산기</h2><div class="related"><a href="/calculators/stock-return.html">주식 수익률 계산기</a><a href="/calculators/compound-interest.html">적립식 복리 계산기</a></div></section>`);
})();
