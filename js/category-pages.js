(function(){
  ...
  const data={
    ...
    life:{
      ...
      comparisons:[['날짜·디데이·일수','날짜 계산은 며칠 전후의 날짜, 디데이는 목표일까지 남은 기간, 일수 계산은 두 날짜 사이 기간을 구합니다.'],['주유비와 여행 경비','주유비는 차량 이동비를 거리·연비로 계산하고, 여행 경비는 교통·숙박·식비 전체 예산을 합산합니다.'],['더치페이와 배송비 분할','더치페이는 사람별 균등 분담에 적합하고, 배송비 분할은 상품 금액이나 수량 기준 배분을 확인할 때 적합합니다.']],
