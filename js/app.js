...
const advancedSearchTools={
  dsr:['DSR 계산기','money'], 'mortgage-loan':['주택담보대출 계산기','money'], 'stock-return':['주식 수익률 계산기','money'], 'prepayment-fee':['중도상환수수료 계산기','money'], 'car-acquisition-tax':['자동차 취득세 계산기','money'],
...
cats.money[3]+=' dsr mortgage-loan stock-return prepayment-fee car-acquisition-tax card-installment housing-subscription monthly-rent-deduction loan-schedule employee-health-insurance';
...
(function(){
  ...
  cats.money[3]+=' mortgage-loan cagr';
