...
const advancedSearchTools={
  ...
  'card-installment':['카드 할부 수수료 계산기','money'], 'housing-subscription':['청약 가점 계산기','money'], 'monthly-rent-deduction':['월세 세액공제 계산기','money'], 'loan-schedule':['대출 상환 스케줄 계산기','money'], 'employee-health-insurance':['직장인 건강보험료 계산기','money'],
