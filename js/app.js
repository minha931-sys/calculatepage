...
const searchBoostIds=['percent','discount','salary','gpa','d-day','dutch-pay','savings-interest','loan-interest','vat','area-conversion','date','work-hours','pet-age','employee-health-insurance'];
...
cats.money[3]+=' dsr stock-return prepayment-fee car-acquisition-tax card-installment housing-subscription monthly-rent-deduction loan-schedule employee-health-insurance';
